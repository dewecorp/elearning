            ...
            <div class="panel-body">
                <form method="post">
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_kelas" class="form-control" placeholder="Nama Kelas" autofocus required />
                    </div>
                    <div class="form-group">
                        <label>Ruang *</label>
                        <input type="text" name="ruang" class="form-control" placeholder="Nama Ruang" required />
                    </div>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form method="post">
                    ...
                    <div class="form-group">
                        <label>Ruang</label>
                        <input type="text" name="ruang" value="<?php echo $data['ruang']; ?>" class="form-control"/>
                    </div>
                    <div class="form-group">
