...
if(file_exists('../../style/assets/img/logo2.png')) {
    $pdf->Image('../../style/assets/img/logo2.png',15,18,16);
}
$pdf->SetTitle("Cetak Data");
$pdf->SetFont('Arial','B',18);
$pdf->Cell(0,5,'SMK TI Muhammadiyah Cikampek','0','1','C',false);
$pdf->SetFont('Arial','i',8);
$pdf->Cell(0,5,'Alamat : Cikampek Karawang','0','1','C',false);
$pdf->Cell(0,2,'Telp : (xxx) xxxxxx - Email : sutankumalabp@gmail.com','0','1','C',false);
$pdf->Ln(3);
