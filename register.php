                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <form method="post" enctype="multipart/form-data">
                            ...
                            Tahun Masuk* :
                            <input type="number" name="thn_masuk" class="form-control" placeholder="Masukkan tahun masuk contoh: 2021" min="1950" max="2030" required />
                            ...
                            if(mysqli_num_rows($sql_cek_user) > 0) {
                                ...
                                if($nama_gambar != '') {
                                    if(move_uploaded_file($sumber, $target.$nama_gambar)) {
                                        mysqli_query($db, "INSERT INTO tb_siswa VALUES(null, '$nis', '$nama_lengkap', '$tempat_lahir', '$tgl_lahir', '$jenis_kelamin', '$agama', '$nama_ayah', '$nama_ibu', '$no_telp', '$email', '$alamat', '$kelas', '$thn_masuk', '$nama_gambar', '$user', md5('$pass'), '$pass', 'tidak aktif')") or die ($db->error);          
